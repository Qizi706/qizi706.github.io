...
readingOrder: 1
readingNote: '机制总览：先建立请求到响应的完整链路'
categories:
  - 'AI Infra'
tags:
  - 'LLM'
...
import LlmBlackBoxReaction from '../../assets/llm-inference-request-lifecycle/llm-black-box-reaction-transparent.png';
