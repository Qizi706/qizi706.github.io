...
这篇文章记录如何理解一个请求从进入 LLM Serving 系统到返回文本的完整过程。第 7 节保留验证摘要，实验环境、故障现场和复现步骤见独立报告[《在 Apple Silicon 上运行 Qwen3-4B：本地 LLM 推理服务实验》](/blog/llm-inference-request-lifecycle-practice/)。
...
- Jay Alammar，[The Illustrated GPT-2](https://jalammar.github.io/illustrated-gpt-2/)
