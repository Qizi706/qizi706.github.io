...
description: "之前做过 15445 Bustub、6.s081 xv6 这类项目，其实已经接触过构建工具了。 比如在 xv6 里经常执行： 在 Bustub 里经常执行： 但如果只是照着项目文档跑命令，很容易形成一种感觉： 我会用这些命令，但不知道它们到底在帮我做什么。 这篇文章想系统学习一下现代 C++ 项目的构建工具，重点..."
