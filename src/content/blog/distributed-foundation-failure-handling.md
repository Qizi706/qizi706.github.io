---
title: '分布式基础：故障处理'
description: '从超时、慢节点和网络分区出发，分析 KV Cache 迁移中断、旧 owner 恢复与请求取消，说明故障检测、fencing 和修复任务的边界。'
pubDate: '2026-07-14T15:30:00+08:00'
updatedDate: '2026-09-07T00:33:57+08:00'
readingOrder: 6
readingNote: '恢复：处理部分失败和旧 owner'
categories:
  - '分布式'
tags:
  - '故障处理'
...
> 系列入口：[分布式阅读路径](/category/分布式/)。 前置：[副本和一致性](/blog/distributed-foundation-replication-consistency/)。 下一篇：[缓存策略、迁移与淘汰](/blog/distributed-foundation-cache-migration-eviction/)。
...
这与[状态机与元数据篇](/blog/distributed-foundation-state-machine-sharding-metadata/)中的 epoch 校验相连。
...
- [Kubernetes Leases](https://kubernetes.io/docs/concepts/architecture/leases/)：对照心跳和 leader election 的实际用途；租约记录本身不替下游拒绝旧 owner 的写入。
- [Google SRE：Handling Overload](https://sre.google/sre-book/handling-overload/)：对照负载丢弃、客户端节流与重试预算，分析故障扩散。
